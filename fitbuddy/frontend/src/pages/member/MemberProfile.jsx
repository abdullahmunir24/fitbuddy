...
const MemberProfile = () => {
  ...
  const stats = [
    { label: 'Total Workouts', value: '28', icon: '💪', color: 'from-blue-500 to-blue-600' },
    { label: 'Classes Joined', value: '7', icon: '🏃', color: 'from-purple-500 to-purple-600' },
    { label: 'Member Since', value: 'Jan 2024', icon: '📅', color: 'from-green-500 to-green-600' },
  ];
